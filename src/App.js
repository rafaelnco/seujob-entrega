...
import { Section, Text, Input, Navigator, Path } from "./Components";
      ...
      <Section horizontal align-center normal-shadow two-apex>
        <Section
          ...
          pressOut={() => {
            ...
            applyTheme(availableThemes[newTheme]);
            setTheme(newTheme);
          }}
        >
        ...
        {scene === 1 && (
          <Section full justify-end>
            <Section pointer-cursor small-padding pressOut={() => setScene(0)}>
              <Text giant-text link-foreground>
                {scenes[0].title}
              </Text>
            </Section>
